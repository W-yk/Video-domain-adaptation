...
class ResCNNEncoder(nn.Module):
    def __init__(self, fc_hidden1=512, fc_hidden2=512,feature = 2048, drop_p=0.3, CNN_embed_dim=300):
        """Load the pretrained ResNet-152 and replace top fc layer."""
        super(ResCNNEncoder, self).__init__()

        self.feature, self.fc_hidden1, self.fc_hidden2 = feature, fc_hidden1, fc_hidden2
        self.drop_p = drop_p

        self.fc1 = nn.Linear(feature, fc_hidden1)
